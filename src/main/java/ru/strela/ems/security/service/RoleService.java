...
//    Customer getRole(Integer userId);
    Role getRoleByName(String roleName);
    List<Role> getEntities();
    List<Role> getAllRoles();
    int getChildrenCount(int id);
    List<Role> getChildren(int parentId);
    List<Role> getChildren(int parentId, int start, int quantity, String sortName, boolean desc);
//    List<Role> getGrantedAuthoritis();
