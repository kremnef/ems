...
public interface ObjectTypeActionService {

    int getChildrenCount(int id);
    List<ObjectTypeAction> getChildren(int parentId);
    List<ObjectTypeAction> getChildren(int parentId, int start, int quantity, String sortName, boolean desc);
    List<ObjectTypeAction> getEntities();
    ObjectTypeActionDao getObjectTypeActionDao();
	void setObjectTypeActionDao(ObjectTypeActionDao objectTypeActionDao);
