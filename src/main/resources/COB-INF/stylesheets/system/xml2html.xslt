...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
   ...
   <xsl:template match="/">
      <HTML>
         <HEAD>
             <link href="{$blockPrefix}/resource/css/prettycontent.css" type="text/css" rel="stylesheet"/>
             <script src="{$blockPrefix}/resource/js/prettycontent.js" type="text/javascript"/>
         </HEAD>
         <BODY>
            <xsl:apply-templates/>
         </BODY>
