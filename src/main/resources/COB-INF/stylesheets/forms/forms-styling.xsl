...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:include href="forms-ckeditor-styling.xsl"/>
    <!--<xsl:include href="forms-jWYSIWYG-styling.xsl"/>-->
    <!--<xsl:include href="forms-alohaeditor-styling.xsl"/>-->
    <!--<xsl:include href="forms-suggestion-list.xsl"/>-->
    <!--<xsl:include href="forms-advanced-field-styling.xsl"/>-->
    <xsl:include href="forms-calendar-styling.xsl"/>

    <!-- Location of the resources directories,dddd where JS libs and icons are stored -->
    ...
    <xsl:template match="head">
        <head>
            ...
            <xsl:apply-templates select="." mode="forms-ckeditor"/>
            <!--<xsl:apply-templates select="." mode="forms-aloha-editor"/>-->
            <xsl:apply-templates/>
            <!--<xsl:apply-templates select="." mode="jWYSIWYG-editor"/>-->
        </head>
    </xsl:template>
